class CustomerAccount:
    def __init__(self, fname, lname, address, account_no, balance, category, interest, loan):
        self.fname = fname
        self.lname = lname
    ...
    def print_details(self):
        print(self.fname, self.lname, self.address, self.account_no, self.balance, self.category, self.interest, self.loan)
